...
(function($, window, document, undefined) {
    ...
    $(document).ready(function() {
        ...
        //     $('#main-nav li').toggleClass('active');
        ...
        var underlineMenuItems = document.querySelectorAll("#main-nav li");
        ...
        //     var myFullpage = new fullpage('#welcomepage', {
        //         licenseKey: ' C7F41B00-5E824594-9A5EFB99-B556A3D5',
        //         anchors: ['slide01', 'slide02'],
        //         menu: '#nav',
        //         lazyLoad: true,
        //         navigation: true,
